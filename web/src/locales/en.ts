...
export default {
  ...
  "mb.actions_whole": "Whole artist",
  "mb.actions_groups": "{n} release group(s)",
  "mb.add_to_library": "Add to library",
  "mb.download_all": "Download all",
  "mb.actions_working": "Working…",
  "mb.actions_add_hint": "Add one album per release group of this type. The wish queue's own search picks them up — this button starts nothing.",
  "mb.actions_download_hint": "Add them and start searching for them now.",
