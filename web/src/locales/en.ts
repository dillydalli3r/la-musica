...
export default {
  ...
  "client.host_help": "This device runs the backend itself: the desktop app starts its own (127.0.0.1:8000), and the web app and Docker are already served by one. A phone bundles no Python — start the backend there with a-Shell, iSH or Termux, or connect to a server instead.",
  "client.host_no_python": "Nothing is answering on this device. A phone cannot bundle Python: start the backend here with a-Shell, iSH or Termux, or go back and connect to a server.",
