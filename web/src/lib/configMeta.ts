...
export const CONFIG_GROUPS: CfgGroup[] = [
    ...
    },
    {
      ...
      fields: [
        ...
        { k: "advisory_ai_classify", label: "Judge the lyrics with the AI provider", type: "bool", help: "When no provider states an advisory, the configured AI model reads the track's lyrics and answers 0/1/2 (3 = it cannot tell, which falls through). Needs an AI base URL and model in the AI section; with no AI configured the word scan below answers instead." },
        { k: "advisory_lyrics_scan", label: "Scan the lyrics for profanity", type: "bool", help: "The multilingual word list: any hit is explicit (1), no hit is clean (0). Runs when the AI is not configured (or could not tell) and the track has lyrics." },
    ...
    },
    {
      ...
      fields: [
        ...
        { k: "grade_check_genre_order", label: "Genre order (the family, if present, is last)", type: "bool", help: "The family must be the LAST genre, e.g. shoegaze / dream pop / rock (issue code GENRE_ORDER). A family in an earlier slot, or a genre repeated, fails. The names themselves are graded by the vocabulary check below." },
    ...
    },
    {
      ...
      fields: [
        ...
        { k: "export_replaygain", label: "Write ReplayGain tags into the export", type: "bool" },
...
export const SETUP_STEPS: SetupStep[] = [
  ...
  },
  {
    ...
    blurb:
      "Sharing your library, and letting the app fill the wishes you save by downloading from the network. Both need a free Soulseek account.",
    panel: "slskd",
