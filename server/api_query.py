...
def _library_fields() -> List[dict]:
    return [
        ...
        _field("library.lyrics_kind", "Lyrics kind", "text", targets=("tracks",),
               values=("synced", "plain"), facetable=True,
               hint="Which kind the stored lyrics are: synced (timed) or plain."),
